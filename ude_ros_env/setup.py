...
setup_args = {
    ...
    "package_dir": {"": "."},
    "description": "The environment part of UDE-ROS bridge implementation to provide the integration between UDE and ROS.",
    "long_description": read("README.md"),
    "long_description_content_type": 'text/markdown',
    "author": "Amazon Web Services",
    "url": "https://github.com/aws-deepracer/ude-ros-bridge/tree/main/ude_ros_env",
